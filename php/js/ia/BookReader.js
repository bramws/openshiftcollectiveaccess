...
function BookReader() {
    ...
    this.topOffset = 30;		// offset from top in 1up and thumb
...
// init()
//______________________________________________________________________________
BookReader.prototype.init = function(params) {
...
//prepareOnePageView()
//______________________________________________________________________________
BookReader.prototype.prepareOnePageView = function(s) {

    // var startLeaf = this.displayedIndices[0];
    var startLeaf = s ? s : this.currentIndex();
...
BookReader.prototype.onePageGetAutofitWidth = function() {
    var widthPadding = 20;
    //return (parseInt(this.getMedianPageSize().width)) / ($('#BRcontainer').attr('clientWidth') - widthPadding * 2);
    return (parseInt(this.getMaxPageWidth())) / ($('#BRcontainer').attr('clientWidth') - widthPadding);
}

BookReader.prototype.onePageGetAutofitHeight = function() {
	// Add 110 pixels to effective height so image fits within nav and tool bars
   // return (parseInt(this.getMedianPageSize().height) + 110) / ($('#BRcontainer').attr('clientHeight') - this.padding * 2); // padding to make sure a little of adjacent pages show
    return (parseInt(this.getMaxPageHeight())) / ($('#BRcontainer').attr('clientHeight') - this.padding); // padding to make sure a little of adjacent pages show
}
...
BookReader.prototype.updateNavPageNum = function(index) {
    ...
    //
    // CollectiveAccess changed (4 September 2011; Seth Kaufman)
    // Provides callback to superclass when page changes
    //
    if(this.onPageChange) { this.onPageChange(index + 1, this.numLeafs); }		// page numbers are 1-based
}
