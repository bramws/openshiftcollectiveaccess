...
?>
	...
	<div class="bundleContainer">
		...
		<div class='button labelInfo caAddLabelButton' style="margin-left: 10px;"><a href='#'><?php print caNavIcon($this->request, __CA_NAV_BUTTON_ADD__); ?> <?php print $vs_add_label ? $vs_add_label : _t("Add label"); ?></a></div>
	</div>
