...
?>
	<textarea class='caLabelTemplate' style='display: none;'>
		<div id="{fieldNamePrefix}Label_{n}" class="labelInfo">
			...
			<?php print $t_label->htmlFormElement('name', "^ELEMENT", array_merge($va_settings, array('caption' => "{fieldNamePrefix}caption_{n}", 'id' => "{fieldNamePrefix}caption_{n}", "value" => "{{caption}}", 'no_tooltips' => true, 'textAreaTagName' => 'textentry'))); ?>
			<br/>
	...
	<div class="bundleContainer">
		...
		<div class='button caAddLabelButton'><a href='#'><?php print caNavIcon($this->request, __CA_NAV_BUTTON_ADD__); ?> <?php print $vs_add_label ? $vs_add_label : _t("Add label"); ?></a></div>
	</div>
</div>
