...
?>
	<textarea class='caLabelTemplate' style='display: none;'>
		<div id="{fieldNamePrefix}Label_{n}" class="labelInfo">
			...
			<?php print $t_label->htmlFormElement('caption', "^ELEMENT", array_merge($va_settings, array('name' => "{fieldNamePrefix}caption_{n}", 'id' => "{fieldNamePrefix}caption_{n}", "value" => "{{caption}}", 'no_tooltips' => true, 'textAreaTagName' => 'textentry'))); ?>
			<br/>
